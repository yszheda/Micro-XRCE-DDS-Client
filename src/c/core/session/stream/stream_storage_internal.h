...
uxrOutputBestEffortStream* uxr_get_output_best_effort_stream_id(
        uxrStreamStorage* storage,
        uint8_t index);

uxrOutputReliableStream* uxr_get_output_reliable_stream_id(
        uxrStreamStorage* storage,
        uint8_t index);

uxrInputBestEffortStream* uxr_get_input_best_effort_stream_id(
        uxrStreamStorage* storage,
        uint8_t index);

uxrInputReliableStream* uxr_get_input_reliable_stream_id(
        uxrStreamStorage* storage,
        uint8_t index);
